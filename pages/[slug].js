...
export default function BlogPost ({ post, blockMap, emailHash }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'px-4 flex justify-between text-sm text-gray-300 dark:text-gray-400 my-5',
      ...
      >
        <a>
          <button
            ...
            className="mt-2 cursor-pointer text-sm hover:text-gray-800 transition duration-100"
          >
            {locale.POST.BACK}
          </button>
        </a>
